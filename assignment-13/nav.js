...
'<nav>'+
	...
	'<div class="navbar">'+
	   ...
	   '<div class="content__left lessen3">'+
           '<a class="active" href="Index.html"><i class="fa fa-caret-home"></i>Home</a>'+

	      '<div class="subnav">'+
		     '<button class="subnavbtn">Inventory <i class="fa fa-caret-down"></i></button>'+

   	         '<div class="subnav-content">'+
		           '<a href="egg_list.html"><i class="fa fa-fw fa-database"></i>View all Items</a>'+
               '<br>'+
        ...
        '<div class="subnav">'+
		     '<button class="subnavbtn">Information <i class="fa fa-caret-down"></i></button>'+
   	         ...
   	         '<div class="subnav-content">'+
		         '<a href="about.html"><i class="fa fa-fw fa-database"></i>About</a>'+
				     '<br>'+
		         '<a href="dragon.html"><i class="fa fa-fw fa-search"></i>Dragon Types</a>'+
	         '</div>'+
      ...
      '</div>'+
	   ...
	   '<div class="content__right lessen2">'+
	      ...
	      '<div class="subnav">'+
		   ...
		   '<a href="logout.html"><i class="fa fa-fw fa-sign-out"></i>Logout</a>'+
	   '</div>'+
    ...
    '<div class="content__left">'+
        ...
        '<div class="subnav">'+
          ...
          '<div class="subnav-content">'+
            ...
            '<br>'+
            '<a href="egg_list.html"><i class="fa fa-fw fa-search"></i>Search Items</a>'+
          '</div>'+
