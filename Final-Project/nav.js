	   ...
	   '<div class="content__left">'+
	      ...
	      '<div class="subnav">'+
		     '<button class="subnavbtn">Inventory <i class="fa fa-caret-down"></i></button>'+
   	         ...
   	         '<div class="subnav-content">'+
		           '<a href="egg_list2.html"><i class="fa fa-fw fa-server"></i>View all Items</a>'+
               '<br>'+
        ...
        '<div class="subnav">'+
		     '<button class="subnavbtn">Information <i class="fa fa-caret-down"></i></button>'+
   	         ...
   	         '<div class="subnav-content">'+
		         '<a href="about2.html"><i class="fa fa-fw fa-info-circle"></i>About</a>'+
				     '<br>'+
		         '<a href="dragon2.html"><i class="fa fa-fw fa-paw"></i>Dragon Types</a>'+
	         '</div>'+
